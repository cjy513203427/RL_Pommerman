...
class DQNAgent(BaseAgent):
    ...
    def new_model(self):
        ...
        model.add(Conv2D(256, 3, (1, 1), input_shape=input_shape[1:], activation="relu", data_format="channels_last",
                         padding="same"))
        model.add(Conv2D(256, 3, (1, 1), activation="relu", data_format="channels_last", padding="same"))
        model.add(Conv2D(256, 3, (1, 1), activation="relu", data_format="channels_last", padding="same"))
        model.add(Flatten())
